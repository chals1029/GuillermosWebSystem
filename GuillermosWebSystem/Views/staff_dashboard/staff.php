...
<head>
  ...
  <style>
    body {background:#f9f6f1; font-family:'Poppins',sans-serif;}
    ...
    .topbar{margin-left:250px;background:#6f4e37;color:#fff;padding:1rem 1.5rem;display:flex;align-items:center;justify-content:space-between;}
    .topbar h4{margin:0;font-weight:700;}
    .content{margin-left:250px;padding:1.5rem;}
    .card-custom{background:#c1976b;color:#fff;border:none;border-radius:10px;text-align:center;padding:1.5rem;}
    .card-custom h5{margin-top:.5rem;}

    /* QUICK ADD CARD */
    .quick-add {
      background:#fff;
      background-color: #ebd2b9ff;
...
<body>
  ...
  <div class="sidebar d-flex flex-column">
    <div class="text-center mb-4"><h4>Guillermo’s</h4></div>
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item"><a class="nav-link active" onclick="showContent('dashboard')">Dashboard</a></li>
      <li>
        <a class="nav-link" data-bs-toggle="collapse" href="#orderMenu" role="button">
          Order Management <i class="bi bi-chevron-down ms-1"></i>
        </a>
        <div class="collapse submenu" id="orderMenu">
          <a href="#" onclick="showContent('process-bulk')">Process Bulk</a>
          <a href="#" onclick="showContent('advance-reservation')">Advance Reservation</a>
        </div>
      </li>
      <li><a class="nav-link" onclick="showContent('inventory')">Inventory</a></li>
    </ul>
  </div>
  ...
  <div class="topbar">
    <div>
      <div class="small">WELCOME BACK, Staff</div>
      <h4>DASHBOARD</h4>
      <div style="font-size:14px;">
        <?php date_default_timezone_set('Asia/Manila'); echo date("l | F j, Y"); echo "   " . date("h:i A"); ?>
      </div>
    </div>
    <div class="d-flex align-items-center">
      <i class="bi bi-bell fs-1 me-3"></i>
      <i class="bi bi-person-circle fs-1" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#profileModal"></i>
    </div>
  </div>
            ...
            <div class="col-lg-8">
              ...
              <div class="category-filter d-flex align-items-center">
                ...
                <select id="categoryFilter" class="form-select category-filter">
                  ...
                  <option value="fruits">Fruits &amp; Yogurt</option>
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            ...
            <table class="table table-hover mb-0 inventory-table">
              ...
              <tbody id="inventoryTableBody">
                ...
                <tr data-category="pasta">
                  ...
                  <td>Pasta</td>
                  <td>₱180</td>
                  <td><span class="stock-badge text-success">48</span></td>
                ...
                <tr data-category="pasta">
                  ...
                  <td>Pasta</td>
                  <td>₱220</td>
                  <td><span class="stock-badge text-warning">8</span></td>
                  <td><span class="badge bg-warning">Low</span></td>
                </tr>
                <tr data-category="rice-meals">
                  <td>P003</td>
                  <td>Beef Caldereta</td>
                  <td>Rice Meals</td>
                  <td>₱200</td>
                  <td><span class="stock-badge text-success">35</span></td>
                  <td><span class="badge bg-success">Safe</span></td>
                </tr>
                <tr data-category="rice-meals">
                  <td>P004</td>
                  ...
                  <td>Rice Meals</td>
                  <td>₱180</td>
                  <td><span class="stock-badge text-danger">3</span></td>
          ...
          <div id="emptyInventory" class="empty-state" style="display:none;">
            ...
            <p class="mb-0">There are no products in inventory yet.</p>
          </div>
        </div>
      </div>
    </div>
